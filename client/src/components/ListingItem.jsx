        ...
        <div className="p-3 flex flex-col gap-2 w-full">
           ...
           <div className="flex items-center gap-1">
             ...
             <div className="flex gap-4">
              ...
              &#2547;
                {listing.ofer ? listing.discountPrice.toLocaleString('en-US') : listing.regularPrice.toLocaleString('en-US')}
                {listing.type === 'rent' && ' / month'}
              </p>
              <p className="text-red-700 mt-2 font-semibold">{listing.phone}</p>
             </div>
